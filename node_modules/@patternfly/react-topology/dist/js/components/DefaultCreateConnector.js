...
const DefaultCreateConnector = ({ startPoint, endPoint, hints, dragging, hover, tipContents, className }) => {
    const classes = (0, react_styles_1.css)(topology_components_1.default.topologyDefaultCreateConnector, className, hover && topology_components_1.default.modifiers.hover, dragging && topology_components_1.default.modifiers.dragging);
    return (React.createElement("g", { className: classes },
        React.createElement("line", { className: (0, react_styles_1.css)(topology_components_1.default.topologyDefaultCreateConnectorLine), x1: startPoint.x, y1: startPoint.y, x2: endPoint.x, y2: endPoint.y }),
        hints && hints[hints.length - 1] === 'create' ? (React.createElement("g", { transform: `translate(${endPoint.x - cursorSize / 2},${endPoint.y - cursorSize / 2})`, className: (0, react_styles_1.css)(topology_components_1.default.topologyDefaultCreateConnectorCreate) },
            React.createElement("circle", { className: (0, react_styles_1.css)(topology_components_1.default.topologyDefaultCreateConnectorCreateBg), cx: cursorSize / 2, cy: cursorSize / 2, r: cursorSize / 2 }),
