...
const Ellipse = ({ className = (0, react_styles_1.css)(topology_components_1.default.topologyNodeBackground), width, height, filter, dndDropRef }) => {
    (0, behavior_1.useAnchor)(anchors_1.EllipseAnchor);
