...
const Stadium = ({ className = (0, react_styles_1.css)(topology_components_1.default.topologyNodeBackground), width, height, filter, dndDropRef }) => {
    const anchorRef = (0, behavior_1.useSvgAnchor)();
    const refs = (0, utils_1.useCombineRefs)(dndDropRef, anchorRef);
    const points = React.useMemo(() => (0, shapeUtils_1.getHullPath)(getStadiumPoints(width, height / 2), height / 2), [height, width]);
