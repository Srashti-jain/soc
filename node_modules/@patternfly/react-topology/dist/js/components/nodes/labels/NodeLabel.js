...
const NodeLabel = (_a) => {
    ...
    const refs = (0, utils_1.useCombineRefs)(dragRef, typeof truncateLength === 'number' ? labelHoverRef : undefined);
    const [textSize, textRef] = (0, utils_1.useSize)([children, truncateLength, className, labelHover]);
    const [secondaryTextSize, secondaryTextRef] = (0, utils_1.useSize)([secondaryLabel, truncateLength, className, labelHover]);
    ...
    return (React.createElement("g", { className: className, ref: refs, transform: `translate(${startX}, ${startY})` },
        ...
        textSize && (React.createElement("rect", { className: (0, react_styles_1.css)(topology_components_1.default.topologyNodeLabelBackground), key: `rect-${filterId}`, filter: filterId && (0, utils_1.createSvgIdUrl)(filterId), x: 0, y: 0, width: width, height: backgroundHeight, rx: cornerRadius, ry: cornerRadius })),
        ...
        textSize && secondaryLabel && (React.createElement(React.Fragment, null,
            React.createElement("line", { className: (0, react_styles_1.css)(topology_components_1.default.topologyNodeSeparator), x1: 0, y1: height, x2: width, y2: height, shapeRendering: "crispEdges" }),
            React.createElement("text", { className: "pf-m-secondary", ref: secondaryTextRef, x: width / 2, y: height + paddingY + ((_b = secondaryTextSize === null || secondaryTextSize === void 0 ? void 0 : secondaryTextSize.height) !== null && _b !== void 0 ? _b : 0) / 2, dy: "0.35em", textAnchor: "middle" }, truncateLength > 0 && !labelHover
                ? (0, truncate_middle_1.truncateMiddle)(secondaryLabel, { length: truncateLength })
                : secondaryLabel))),
        ...
        React.createElement("text", Object.assign({}, other, { ref: textRef, x: iconSpace + badgeSpace + paddingX, y: height / 2, dy: "0.35em" }), truncateLength > 0 && !labelHover ? (0, truncate_middle_1.truncateMiddle)(children, { length: truncateLength }) : children),
        textSize && actionIcon && (React.createElement(React.Fragment, null,
            React.createElement("line", { className: (0, react_styles_1.css)(topology_components_1.default.topologyNodeSeparator), x1: actionStartX, y1: 0, x2: actionStartX, y2: height, shapeRendering: "crispEdges" }),
        ...
        textSize && onContextMenu && (React.createElement(React.Fragment, null,
            React.createElement("line", { className: (0, react_styles_1.css)(topology_components_1.default.topologyNodeSeparator), x1: contextStartX, y1: 0, x2: contextStartX, y2: height, shapeRendering: "crispEdges" }),
