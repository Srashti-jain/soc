...
const LabelBadge = React.forwardRef(({ badge, badgeTextColor, badgeColor, badgeBorderColor, badgeClassName, className, x, y }, iconRef) => {
    ...
    return (React.createElement("g", { className: classes, transform: `translate(${x}, ${y})` },
        rect,
        React.createElement("text", { fill: badgeTextColor || badgeClassName ? undefined : global_palette_blue_300_2.global_palette_blue_300.value, ref: textRef, x: width / 2 + paddingX, y: height / 2, textAnchor: "middle", dy: "0.35em" }, badge)));
});
