...
const Decorator = ({ className, x, y, showBackground, radius, padding = nodes_1.DEFAULT_DECORATOR_PADDING, children, icon, onClick, ariaLabel, circleRef }) => {
    ...
    return (React.createElement("g", Object.assign({ ref: hoverRef, className: (0, react_styles_1.css)(topology_components_1.default.topologyNodeDecorator, className) }, (onClick
        ? {
            onClick: e => {
                e.stopPropagation();
                onClick(e);
