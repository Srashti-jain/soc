...
const DefaultConnectorTerminal = (_a) => {
    ...
    const classes = (0, react_styles_1.css)(topology_components_1.default.topologyEdge, className, utils_1.StatusModifier[status]);
...
exports.default = (0, mobx_react_1.observer)(DefaultConnectorTerminal);
