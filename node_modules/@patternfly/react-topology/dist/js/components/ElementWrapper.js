...
const NodeElementComponent = (0, mobx_react_1.observer)(({ element }) => {
    ...
    const isVisible = React.useMemo(() => (0, mobx_1.computed)(() => controller.shouldRenderNode(element)), [element, controller]);
...
const ElementChildren = (0, mobx_react_1.observer)(({ element }) => (React.createElement(React.Fragment, null,
    ...
    element
        ...
        .map(e => (React.createElement(ElementWrapper, { key: e.getId(), element: e }))))));
const ElementWrapper = (0, mobx_react_1.observer)(({ element }) => {
