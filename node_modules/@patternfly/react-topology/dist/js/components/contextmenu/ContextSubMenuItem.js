...
const ContextSubMenuItem = (_a) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(react_core_1.DropdownItem, Object.assign({}, other, { className: (0, react_styles_1.css)(topology_components_1.default.topologyContextSubMenu), component: React.createElement("button", { ref: nodeRef, type: "button", 
                ...
                label,
                React.createElement(angle_right_icon_1.default, { className: (0, react_styles_1.css)(topology_components_1.default.topologyContextSubMenuArrow) })) })),
        React.createElement(Popper_1.default, { open: open, placement: "right-start", closeOnEsc: true, closeOnOutsideClick: true, onRequestClose: e => {
            ...
            React.createElement("div", { ref: subMenuRef, role: "presentation", className: "pf-c-dropdown pf-m-expanded", onMouseLeave: e => {
                ...
                React.createElement(react_core_1.DropdownMenu, { className: (0, react_styles_1.css)(topology_components_1.default.topologyContextMenuCDropdownMenu), autoFocus: true }, children)))));
};
