...
const TopologySideBar = (_a) => {
    ...
    const classNames = resizable
        ? (0, react_styles_1.css)(topology_side_bar_1.default.topologyResizableSideBar, className)
        : (0, react_styles_1.css)(topology_side_bar_1.default.topologySideBar, 'fade', className, show && topology_side_bar_1.default.shown, isIn && topology_side_bar_1.default.in);
    return (React.createElement("div", Object.assign({}, otherProps, { role: "dialog", className: classNames }), (resizable || show) && (React.createElement(React.Fragment, null,
        onClose && (React.createElement(react_core_1.Button, { className: (0, react_styles_1.css)(topology_side_bar_1.default.topologySideBarDismiss), variant: "plain", onClick: onClose, "aria-label": "Close" },
            React.createElement(times_icon_1.default, null))),
        header && React.createElement("div", { className: (0, react_styles_1.css)(topology_side_bar_1.default.topologySideBarHeader) }, header),
        children))));
};
