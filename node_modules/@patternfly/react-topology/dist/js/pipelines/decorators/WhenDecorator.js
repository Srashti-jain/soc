...
const WhenDecorator = ({ element, width = exports.DEFAULT_WHEN_SIZE, height = exports.DEFAULT_WHEN_SIZE, className, status, leftOffset = exports.DEFAULT_WHEN_OFFSET, edgeLength = exports.DEFAULT_WHEN_OFFSET, toolTip, disableTooltip = false }) => {
    ...
    const diamondNode = (React.createElement("g", { className: className },
        React.createElement("line", { className: (0, react_styles_1.css)(topology_components_1.default.topologyEdgeBackground), x1: -leftOffset, y1: taskHeight / 2 - height / 2, x2: -leftOffset + edgeLength, y2: taskHeight / 2 - height / 2 }),
        React.createElement("line", { className: (0, react_styles_1.css)(topology_components_1.default.topologyEdge, topology_pipelines_1.default.topologyPipelinesWhenExpressionEdge), x1: -leftOffset, y1: taskHeight / 2, x2: -leftOffset + edgeLength, y2: taskHeight / 2 }),
...
exports.default = (0, mobx_exports_1.observer)(exports.WhenDecorator);
