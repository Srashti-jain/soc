...
const TaskEdge = ({ element, className, nodeSeparation }) => {
    ...
    const groupClassName = (0, react_styles_1.css)(topology_components_1.default.topologyEdge, className);
    ...
    return (React.createElement("g", { "data-test-id": "task-handler", className: groupClassName, fillOpacity: 0 },
        React.createElement("path", { d: (0, utils_1.integralShapePath)(startPoint, endPoint, startIndent, nodeSeparation), transform: "translate(0.5,0.5)", shapeRendering: "geometricPrecision" })));
};
exports.default = (0, mobx_react_1.observer)(TaskEdge);
