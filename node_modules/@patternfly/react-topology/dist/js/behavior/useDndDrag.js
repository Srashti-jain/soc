...
const useDndDrag = (spec, props) => {
    ...
    const refCallback = (0, useCallbackRef_1.default)(React.useCallback((node) => {
        let ownerDocument;
        if (node) {
            ...
            () => {
                ...
                const updateOperation = (0, mobx_1.action)(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                d3.select(ownerDocument)
                    .on(createKeyHandlerId('keydown'), (0, mobx_1.action)(() => {
                    const e = d3.event;
                    if (e.key === 'Escape') {
...
const withDndDrag = (spec) => (WrappedComponent) => {
    const Component = props => {
        ...
        const [dndDragProps, dndDragRef] = (0, exports.useDndDrag)(spec, props);
