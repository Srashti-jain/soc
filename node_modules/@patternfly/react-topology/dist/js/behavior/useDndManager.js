...
class DndManagerImpl {
    ...
    canDropOnTarget(targetId) {
        ...
        return (0, exports.matchesType)(target.type, draggedItemType) && target.canDrop(this);
    }
    isDragging() {
    ...
    isOverTarget(targetId, options = { shallow: false }) {
        ...
        const draggedItemType = this.getItemType();
        if (draggedItemType && !(0, exports.matchesType)(target.type, draggedItemType)) {
            return false;
        }
    ...
    endDrag() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (source) {
                    yield (0, mobx_1.runInAction)(() => source.endDrag(this));
                }
            }
            finally {
                this.ending = false;
    ...
    performHitTests() {
        ...
        if (event && draggedItemType) {
            ...
            Object.keys(this.targets).forEach(targetId => {
                const target = this.getTarget(targetId);
                if (target && (0, exports.matchesType)(target.type, draggedItemType) && target.hitTest(event.x, event.y)) {
