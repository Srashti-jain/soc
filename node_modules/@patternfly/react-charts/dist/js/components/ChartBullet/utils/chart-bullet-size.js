...
// destructure last
theme = ChartUtils_1.getBulletComparativeErrorMeasureTheme(themeColor) }) => exports.scaleBarWidth({
...
// destructure last
theme = ChartUtils_1.getBulletComparativeMeasureTheme(themeColor) }) => exports.scaleBarWidth({
    defaultSize: theme.bar.height,
    height,
    horizontal,
...
// destructure last
theme = ChartUtils_1.getBulletComparativeWarningMeasureTheme(themeColor) }) => exports.scaleBarWidth({
    defaultSize: theme.bar.height,
    height,
    horizontal,
...
// destructure last
theme = ChartUtils_1.getBulletPrimaryDotMeasureTheme(themeColor) }) => exports.scaleSize({
...
// destructure last
theme = ChartUtils_1.getBulletPrimarySegmentedMeasureTheme(themeColor) }) => exports.scaleBarWidth({
    defaultSize: theme.group.height,
    height,
    horizontal,
    scale: 0.3,
...
// destructure last
theme = ChartUtils_1.getBulletQualitativeRangeTheme(themeColor) }) => exports.scaleBarWidth({
    defaultSize: theme.group.height,
    height,
    horizontal,
