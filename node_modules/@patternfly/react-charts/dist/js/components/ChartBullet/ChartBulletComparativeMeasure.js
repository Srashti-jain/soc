...
themeVariant, y, 
// destructure last
theme = ChartUtils_1.getBulletComparativeMeasureTheme(themeColor), height = theme.bar.height, width = theme.bar.width, labelComponent = React.createElement(ChartTooltip_1.ChartTooltip, null) }) => {
