...
themeVariant, y, y0, 
// destructure last
theme = ChartUtils_1.getBulletQualitativeRangeTheme(themeColor), height = theme.group.height, width = theme.group.width, labelComponent = React.createElement(ChartTooltip_1.ChartTooltip, null) }) => {
    const computedData = utils_1.getQualitativeRangeData({
        data,
        invert,
        theme,
        y,
...
hoist_non_react_statics_1.default(exports.ChartBulletQualitativeRange, victory_bar_1.VictoryBar);
