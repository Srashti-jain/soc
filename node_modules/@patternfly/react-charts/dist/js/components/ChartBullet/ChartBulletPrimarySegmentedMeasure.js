...
themeVariant, y, y0, 
// destructure last
theme = ChartUtils_1.getBulletPrimarySegmentedMeasureTheme(themeColor), negativeMeasureTheme = ChartUtils_1.getBulletPrimaryNegativeMeasureTheme(themeColor), height = theme.group.height, width = theme.group.width, labelComponent = React.createElement(ChartTooltip_1.ChartTooltip, null) }) => {
