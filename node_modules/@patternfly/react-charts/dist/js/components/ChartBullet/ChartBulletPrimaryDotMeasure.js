...
themeVariant, y, y0, 
// destructure last
theme = ChartUtils_1.getBulletPrimaryDotMeasureTheme(themeColor), labelComponent = React.createElement(ChartTooltip_1.ChartTooltip, null), height = theme.group.height, width = theme.group.width }) => {
    const computedData = utils_1.getPrimaryDotMeasureData({
        data,
        invert,
        theme,
        y,
...
hoist_non_react_statics_1.default(exports.ChartBulletPrimaryDotMeasure, victory_scatter_1.VictoryScatter);
