...
const ChartThreshold = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = ChartUtils_1.getThresholdTheme(themeColor) } = _a, rest = tslib_1.__rest(_a, ["style", "themeColor", "themeVariant", "theme"]);
    ...
    const getStrokeDasharray = () => {
        ...
        return ChartUtils_1.getThresholdTheme(themeColor).line.style.data.strokeDasharray;
    };
    const getStrokeWidth = () => {
        if (style && style.data && style.data.strokeWidth) {
            return style.data.strokeWidth;
        }
        return ChartUtils_1.getThresholdTheme(themeColor).line.style.data.strokeWidth;
    };
