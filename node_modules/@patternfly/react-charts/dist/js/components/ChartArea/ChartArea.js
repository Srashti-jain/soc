...
const ChartArea = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor) } = _a, rest = tslib_1.__rest(_a, ["containerComponent", "themeColor", "themeVariant", "theme"]);
...
hoist_non_react_statics_1.default(exports.ChartArea, victory_area_1.VictoryArea);
