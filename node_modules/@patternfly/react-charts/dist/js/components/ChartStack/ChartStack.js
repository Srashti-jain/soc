...
const ChartStack = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor) } = _a, rest = tslib_1.__rest(_a, ["ariaDesc", "ariaTitle", "children", "colorScale", "containerComponent", "hasPatterns", "patternScale", "themeColor", "themeVariant", "theme"]);
    ...
    const { defaultPatternScale } = ChartUtils_1.useDefaultPatternProps({
        colorScale,
        hasPatterns,
        patternScale,
    ...
    return (React.createElement(victory_stack_1.VictoryStack, Object.assign({ colorScale: colorScale, containerComponent: container, theme: theme }, rest), ChartUtils_1.renderChildrenWithPatterns({
        children,
