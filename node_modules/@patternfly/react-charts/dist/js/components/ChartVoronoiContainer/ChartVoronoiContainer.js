...
const ChartVoronoiContainer = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor), labelComponent = React.createElement(ChartTooltip_1.ChartTooltip, null) } = _a, // Note that Victory provides its own tooltip component here
