...
const ChartLegend = (_a) => {
    var { colorScale, containerComponent = React.createElement(ChartContainer_1.ChartContainer, null), dataComponent = React.createElement(ChartPoint_1.ChartPoint, null), labelComponent = React.createElement(ChartLabel_1.ChartLabel, null), name, patternScale, responsive = true, style, themeColor, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    themeVariant, titleComponent = React.createElement(ChartLabel_1.ChartLabel, null), 
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor) } = _a, rest = tslib_1.__rest(_a, ["colorScale", "containerComponent", "dataComponent", "labelComponent", "name", "patternScale", "responsive", "style", "themeColor", "themeVariant", "titleComponent", "theme"]);
    ...
    const getLabelComponent = () => React.cloneElement(labelComponent, Object.assign(Object.assign({}, (name && { id: (props) => `${name}-${labelComponent.type.displayName}-${props.index}` })), labelComponent.props));
    const getTitleComponent = () => React.cloneElement(titleComponent, Object.assign({}, titleComponent.props));
    // Note: containerComponent is required for theme
    return (React.createElement(victory_legend_1.VictoryLegend, Object.assign({ colorScale: colorScale, containerComponent: container, dataComponent: dataComponent, labelComponent: getLabelComponent(), style: getDefaultStyle(), theme: theme, titleComponent: getTitleComponent() }, rest)));
};
...
exports.ChartLegend.getBaseProps = (props) => {
    const theme = ChartUtils_1.getTheme(null);
