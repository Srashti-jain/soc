...
const Chart = (_a) => {
    ...
    const container = React.cloneElement(containerComponent, Object.assign(Object.assign(Object.assign({ desc: ariaDesc, title: ariaTitle, theme }, containerComponent.props), { className: ChartUtils_1.getClassName({ className: containerComponent.props.className }) }), (labelComponent && { labelComponent }) // Override label component props
    ));
    ...
    const getLegend = () => {
        ...
        return ChartUtils_1.getComputedLegend(Object.assign({ allowWrap: legendAllowWrap, chartType: 'chart', colorScale,
            dx,
            dy,
    ...
    const renderChildren = () => React.Children.toArray(children).map((child, index) => {
        if (React.isValidElement(child)) {
            ...
            return React.cloneElement(child, Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ colorScale }, (defaultPatternScale && { patternScale: defaultPatternScale })), (name &&
                ...
                data: ChartUtils_1.getDefaultData(childProps.data, defaultPatternScale)
    ...
    return (React.createElement(victory_chart_1.VictoryChart, Object.assign({ colorScale: colorScale, containerComponent: container, height: height, padding: defaultPadding, theme: theme, width: width }, rest),
        renderChildren(),
        getLegend(),
        isPatternDefs && ChartUtils_1.getPatternDefs({ patternId, colorScale: defaultColorScale })));
};
exports.Chart = Chart;
