...
const ChartAxis = (_a) => {
    var { containerComponent = React.createElement(ChartContainer_1.ChartContainer, null), name, showGrid = false, themeColor, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    themeVariant, tickLabelComponent = React.createElement(ChartLabel_1.ChartLabel, null), 
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor) } = _a, rest = tslib_1.__rest(_a, ["containerComponent", "name", "showGrid", "themeColor", "themeVariant", "tickLabelComponent", "theme"]);
    ...
    return (React.createElement(victory_axis_1.VictoryAxis, Object.assign({ containerComponent: container, theme: showGrid ? ChartUtils_1.getAxisTheme(themeColor) : theme, tickLabelComponent: getTickLabelComponent() }, rest)));
};
