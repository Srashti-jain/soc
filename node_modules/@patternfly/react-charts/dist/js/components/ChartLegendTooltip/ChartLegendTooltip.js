...
const ChartLegendTooltip = (_a) => {
    ...
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor) } = _a, rest = tslib_1.__rest(_a, ["activePoints", "datum", "center", "flyoutHeight", "flyoutWidth", "height", "isCursorTooltip", "labelComponent", "legendData", "patternScale", "text", "themeColor", "themeVariant", "title", "width", "theme"]);
    ...
    const legendTooltipProps = () => ({
        ...
        legendProps: ChartUtils_1.getLegendTooltipDataProps(labelComponent.props.legendComponent ? labelComponent.props.legendComponent.props : undefined),
