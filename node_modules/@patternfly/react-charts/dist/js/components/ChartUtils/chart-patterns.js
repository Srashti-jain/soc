 ...
 * @private
 */
const getPatternId = () => uniqueId_1.default('pf-pattern');
...
const getPatternDefs = ({ colorScale, offset = 0, patternId, patternUnshiftIndex = 0 }) => {
    ...
    const defs = (React.createElement(React.Fragment, { key: `defs` },
        React.createElement("defs", null, colorScale.map((color, index) => {
            ...
            const id = exports.getPatternDefsId(patternId, index);
 ...
 * @private
 */
const getPatternScale = (colorScale, patternId) => colorScale.map((val, index) => `url(#${exports.getPatternDefsId(patternId, index)})`);
...
const getDefaultPatternScale = ({ colorScale, patternId, patternScale }) => {
    ...
    const defaultPatternScale = exports.getPatternScale(colorScale, patternId);
...
const useDefaultPatternProps = ({ colorScale, hasPatterns, patternScale, themeColorScale }) => {
    const defaultColorScale = exports.getDefaultColorScale(colorScale, themeColorScale);
    let defaultPatternScale = patternScale;
    let isPatternDefs = !patternScale && hasPatterns !== undefined;
    const patternId = React.useMemo(() => (isPatternDefs ? exports.getPatternId() : undefined), [isPatternDefs]);
    if (isPatternDefs) {
        defaultPatternScale = exports.getDefaultPatternScale({
