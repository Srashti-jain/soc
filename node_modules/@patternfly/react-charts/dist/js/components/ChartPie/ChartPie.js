...
const ChartPie = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor), labelComponent = allowTooltip ? (React.createElement(ChartTooltip_1.ChartTooltip, { constrainToVisibleArea: constrainToVisibleArea, theme: theme })) : (undefined), legendOrientation = theme.legend.orientation, height = theme.pie.height, width = theme.pie.width } = _a, rest = tslib_1.__rest(_a, ["allowTooltip", "ariaDesc", "ariaTitle", "colorScale", "constrainToVisibleArea", "containerComponent", "hasPatterns", "legendAllowWrap", "legendComponent", "legendData", "legendPosition", "name", "patternScale", "patternUnshiftIndex", "padding", "radius", "standalone", "style", "themeColor", "themeVariant", "theme", "labelComponent", "legendOrientation", "height", "width"]);
    ...
    const { defaultColorScale, defaultPatternScale, isPatternDefs, patternId } = ChartUtils_1.useDefaultPatternProps({
        colorScale,
        hasPatterns,
        patternScale,
    ...
    const getLegend = () => {
        ...
        return ChartUtils_1.getComputedLegend(Object.assign({ allowWrap: legendAllowWrap, chartType: 'pie', height, legendComponent: legend, padding: defaultPadding, position: legendPosition, theme,
    ...
    const container = standalone
        ? React.cloneElement(containerComponent, Object.assign({ desc: ariaDesc, height, title: ariaTitle, width,
            ...
            chart,
            getLegend(),
            isPatternDefs && ChartUtils_1.getPatternDefs({ patternId, colorScale: defaultColorScale, patternUnshiftIndex })
        ])
        : null;
