...
const ChartCursorContainer = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor), cursorLabelComponent = React.createElement(ChartLabel_1.ChartLabel, null) } = _a, // Note that Victory provides its own label component here
