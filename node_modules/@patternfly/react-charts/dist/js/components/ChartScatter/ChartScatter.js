...
const ChartScatter = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor), size = ({ active }) => (active ? ChartTheme_1.ChartScatterStyles.activeSize : ChartTheme_1.ChartScatterStyles.size) } = _a, rest = tslib_1.__rest(_a, ["containerComponent", "themeColor", "themeVariant", "theme", "size"]);
